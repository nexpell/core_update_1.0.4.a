...
$signatur = TextFormatter::htmlNormalize($_POST['signatur'] ?? '');
    ...
    $twitter   = normalize_external_url((string)($_POST['twitter'] ?? ''));
    $facebook  = normalize_external_url((string)($_POST['facebook'] ?? ''));
    $website   = normalize_external_url((string)($_POST['website'] ?? ''));
    $github    = normalize_external_url((string)($_POST['github'] ?? ''));
    $instagram = normalize_external_url((string)($_POST['instagram'] ?? ''));
