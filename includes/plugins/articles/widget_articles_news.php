    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card border-start border-4 border-primary shadow-sm h-100">
            <div class="card-body d-flex flex-column">
                ...
                <a href="<?= htmlspecialchars(SeoUrlHandler::convertToSeoUrl('index.php?site=articles&action=watch&id=' . (int)$article['id']), ENT_QUOTES, 'UTF-8') ?>" class="btn btn-sm btn-outline-primary mt-auto">
