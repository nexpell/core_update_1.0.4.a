...
if (isset($_POST['save_settings'])) {
    if ($CAPCLASS->checkCaptcha(0, $_POST['captcha_hash'])) {
        ...
        nx_audit_update('admin_userlist', null, true, null, 'admincenter.php?site=admin_userlist');
        nx_redirect('admincenter.php?site=admin_userlist', 'success', 'settings_saved_success', false);
    } else {
        nx_redirect('admincenter.php?site=admin_userlist', 'danger', 'transaction_invalid', false);
    }
}
?>
<form method="post" action="admincenter.php?site=admin_userlist" class="needs-validation" novalidate>
    ...
    <div class="row g-4">
        <div class="col-md-6">
            <div class="card shadow-sw h-100 mb-4 mt-4">
                <div class="card-header">
                    <div class="card-title">
                        <i class="bi bi-gear"></i> <?= $languageService->get('general_settings_header') ?>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row g-3">
        ...
        <div class="col-md-6">
            <div class="card shadow-sm h-100 mb-4 mt-4">
                <div class="card-header">
                    <div class="card-title">
                        <i class="bi bi-display"></i> <?= $languageService->get('display_settings_header') ?>
                    </div>
                </div>
        ...
        <div class="col-md-6">
            <div class="card shadow-sm h-100 mb-4 mt-4">
                <div class="card-header">
                    <div class="card-title">
                        <i class="bi bi-filter"></i> <?= $languageService->get('sort_filter_header') ?>
                    </div>
                </div>
                <div class="card-body row g-3">
                    <div class="col-md-3">
        ...
        <div class="col-md-6">
            <div class="card shadow-sm h-100 mb-4 mt-4">
                <div class="card-header">
                    <div class="card-title">
                        <i class="bi bi-palette"></i> <?= $languageService->get('pagination_design_header') ?>
                    </div>
                </div>
                <div class="card-body row g-3">
                    <div class="col-md-3">
    ...
    <div class="mt-5">
        <button type="submit" name="save_settings" class="btn btn-primary"><?= $languageService->get('save') ?></button>
    </div>
</form>