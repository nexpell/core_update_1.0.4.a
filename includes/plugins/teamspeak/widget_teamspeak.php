...
if (
    ...
    // HTML rendern
    $renderer = new TeamSpeakHtmlRendererWidget($srv);
    ...
    $serverNameRaw = $data['server']['name'] ?: $srv['title'];

    $maxLen = 40;

    $serverName = (mb_strlen($serverNameRaw) > $maxLen)
        ? mb_substr($serverNameRaw, 0, $maxLen - 1) . '…'
        : $serverNameRaw;
