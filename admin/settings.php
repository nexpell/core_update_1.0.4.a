...
if (isset($_POST['submit'])) {
    ...
    if ($CAPCLASS->checkCaptcha(0, $_POST['captcha_hash'] ?? '')) {
        ...
        $twofa_force_all = isset($_POST['twofa_force_all']) ? 1 : 0;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['generate'])) {
    ...
    $CAPCLASS = new \nexpell\Captcha;
    if (!$CAPCLASS->checkCaptcha(0, $_POST['captcha_hash'] ?? '')) {
        // Keine Audit-Zeile: keine gÃ¼ltige Aktion ausgefÃ¼hrt
        nx_redirect('admincenter.php?site=settings', 'danger', 'alert_transaction_invalid', false);
    }
        ...
        <div class="row g-4 align-items-stretch">
            ...
            <div class="col-12 col-xl-6">
                <div class="card shadow-sm border-0 h-100 position-relative">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-3">
                            <label for="webkey" class="form-label fw-semibold">' . $languageService->get('web_key') . ':</label>
                            <input id="webkey" class="form-control" type="text" name="webkey" value="' . htmlspecialchars($ds['webkey']) . '" placeholder="' . $languageService->get('web_key') . '">
                        </div>
                        <div class="mb-0">
                            <label for="seckey" class="form-label fw-semibold">' . $languageService->get('secret_key') . ':</label>
                            <input id="seckey" class="form-control" type="text" name="seckey" value="' . htmlspecialchars($ds['seckey']) . '" placeholder="' . $languageService->get('secret_key') . '">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <span>' . htmlspecialchars($languageService->get('twofa_settings_title')) . '</span>
                            <small class="small-muted">' . htmlspecialchars($languageService->get('twofa_settings_subtitle')) . '</small>
                        </div>
                    </div>
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center flex-wrap gap-2 gap-md-3 mb-2">
                            <label class="form-label fw-semibold mb-0">' . htmlspecialchars($languageService->get('twofa_force_all')) . '</label>
                ...
                <div class="row g-4">
                    <div class="col-12 col-lg-6 d-flex">
                        <div class="card shadow-sm border-0 h-100 w-100">
                            ...
                            <div class="card-body p-4 d-flex flex-column gap-4 h-100 justify-content-center">
                                ...
                                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                                    ...
                                    <a href="admincenter.php?site=seo_meta" class="btn btn-secondary" title="' . $languageService->get('meta_manage_btn_desc') . '">
                        ...
                        <div class="row g-4 h-100">
                                ...
                                <div class="card shadow-sm border-0 h-100">
                                    ...
                                    <div class="card-body p-4 d-flex align-items-center">
                                        <div class="w-100 d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                                            <span class="fw-semibold">' . htmlspecialchars($languageService->get('additional_options')) . ':</span>
                            ...
                            <div class="col-12">
                                <div class="card shadow-sm border-0 h-100">
                                    ...
                                    <div class="card-body p-4 d-flex align-items-center">
                                        <div class="w-100 d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                                            <span class="fw-semibold">' . htmlspecialchars($languageService->get('startpage')) . ':</span>
                                            <select class="form-select form-select-sm w-auto" name="startpage">' . $widget_startpage . '</select>
                                        </div>
                                    </div>
                                </div>
                            </div>
